...
import type { HttpRequest, LoadSurveyById, SurveyModel, SaveSurveyResultParam, SaveSurveyResult, SurveyResultModel } from './save-survey-result-controller-protocols'
